...
<div class="max-w-2xl mx-auto my-12">
    <div class="card-modern overflow-hidden text-center">
        <div class="p-8 text-white" style="background:linear-gradient(135deg,#f59e0b 0%,#d97706 100%)">
            ...
            <h3 class="text-xl font-semibold text-white">Edit Siswa</h3>
            <p class="mt-1 opacity-75 text-sm">Perbarui data siswa</p>
        </div>
        <div class="p-6">
            <?php if (!empty($error)): ?>
            ...
            <form method="POST" class="text-left">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="gender-opt border-2 border-gray-200 rounded-xl p-4 text-center cursor-pointer transition-all hover:border-primary <?= ($siswa['jenis_kelamin'] === 'Laki-laki') ? 'selected' : '' ?>" onclick="selectGender(this,'Laki-laki')">
                            <input type="radio" name="jenis_kelamin" value="Laki-laki" class="hidden" <?= ($siswa['jenis_kelamin'] === 'Laki-laki') ? 'checked' : '' ?>>
                            <i class="fas fa-male block text-xl mb-2 text-primary"></i>
                            <span class="text-sm">Laki-laki</span>
                        </label>
                        <label class="gender-opt border-2 border-gray-200 rounded-xl p-4 text-center cursor-pointer transition-all hover:border-primary <?= ($siswa['jenis_kelamin'] === 'Perempuan') ? 'selected' : '' ?>" onclick="selectGender(this,'Perempuan')">
                            <input type="radio" name="jenis_kelamin" value="Perempuan" class="hidden" <?= ($siswa['jenis_kelamin'] === 'Perempuan') ? 'checked' : '' ?>>
